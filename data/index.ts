export const navItems = [
  ...
  export const gridItems = [
    ...
    {
      id: 4,
      title: "Tech enthusiast with a passion for development and learning.",
      description: "",
    ...
    {
      id: 5,
      title: "Currently building a full fledged website and application.",
    ...
    {
      id: 6,
      title: "Do you want to collab together?",
      description: "",
      className: "lg:col-span-2 md:col-span-3 md:row-span-1",
      imgClassName: "",
  ...
  export const projects = [
    ...
    },
    {
      ...
      link: "https://github.com/imshivam1/iphone",
    },
  ];
  ...
  export const workExperience = [
    ...
    {
      id: 2,
      title: "Web App - JobShop",
      desc: "Designed and developed web app for both mobile and web platforms using basic tools both backend and frontend.",
